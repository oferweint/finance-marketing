        ...
        <div className="space-y-3">
          {correlatedAssets.map((asset, i) => (
            ...
            >
              ...
              <div className="text-right">
                <div className="font-bold" style={{ color: getCorrelationColor(asset.correlation) }} suppressHydrationWarning>
              ...
              <div className="text-right">
                <div className="text-sm font-medium" suppressHydrationWarning>{asset.velocity.toFixed(1)}</div>
